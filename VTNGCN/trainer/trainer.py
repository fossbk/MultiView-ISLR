        ...
        for idx, data in enumerate(tqdm(dataloader)):
            ...
            if self.cfg['training']['criterion'] == "OLM_Loss":
                ...
                if self.cfg['training']['mixup']:
                    ...
                    # Tính các loss phụ (auxiliary loss) không áp dụng mixup.
                    # Loại bỏ phần logits để tránh tính lại classification loss.
                    ...
                    # Gộp loss dict từ mixup classification và các loss phụ.
