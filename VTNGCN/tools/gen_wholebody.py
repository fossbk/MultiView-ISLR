...
def gen_pose(base_url,file_name,wholebody_detector):
    ...
    kp_folder = video_url.replace("videos",'wholebody').replace('.mp4',"")
...
if __name__ == "__main__":
    ...
    for idx,data in full_data.iterrows():
        gen_pose("/home/ibmelab/Documents/GG/VSLRecognition/vsl/videos",data['file_name'],wholebody_detector)
